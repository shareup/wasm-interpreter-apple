...
final class WasmInterpreterTests: XCTestCase {
    func testInitializingWasmInterpreter() throws {
        let interpreter = try WasmInterpreter(stackSize: 512)
        XCTAssertNotNil(interpreter)
    }

    func testLoadingAndUsingAddModule() throws {
    ...
    func testLoadingAndUsingFibonacciModule() throws {
    ...
    static var allTests = [
        ("testInitializingWasmInterpreter", testInitializingWasmInterpreter),
        ("testLoadingAndUsingAddModule", testLoadingAndUsingAddModule),
        ("testLoadingAndUsingFibonacciModule", testLoadingAndUsingFibonacciModule),
    ]
}
